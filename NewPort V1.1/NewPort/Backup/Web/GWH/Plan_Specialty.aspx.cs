...
{
    public partial class Plan_Specialty : System.Web.UI.Page
    {
        static string strid = ""; 
        Maticsoft.BLL.NewPort.Table_project bll = new Maticsoft.BLL.NewPort.Table_project();
        Maticsoft.BLL.NewPort.Table_specialFundRecord bllsf = new Maticsoft.BLL.NewPort.Table_specialFundRecord();
