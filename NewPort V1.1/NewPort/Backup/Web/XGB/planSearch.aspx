<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_XGB.Master" AutoEventWireup="true" CodeBehind="planSearch.aspx.cs" Inherits="Maticsoft.Web.XGB.planSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MiddleContent" runat="server">
    ...
    <asp:GridView ID="GridView_mProject" runat="server" AutoGenerateColumns="False" 
        ...
        <asp:BoundField DataField="project_id" HeaderText="项目编号" 
            ...
            <asp:BoundField DataField="project_class" HeaderText="计划类别" 
                SortExpression="project_class" />
            <asp:HyperLinkField HeaderText="查看详情" ControlStyle-Width="50" 
                DataNavigateUrlFields="project_id" DataNavigateUrlFormatString="plan_Details.aspx?id={0}"
